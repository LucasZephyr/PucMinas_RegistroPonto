...
$getSolicitacao = $sql->getAbonosPorUsuarios2($_SESSION['usuario']['id_usuario'], $_REQUEST['id_abono']);

$getRegistros = $sql->getRegistroAbonoPorDia($_REQUEST['dia'] ,$_SESSION['usuario']['id_usuario']);
